...
// Temps de compilation total: 1.914 ms
//
...
#documents_joints .item .mode {opacity:0.1;}
#documents_joints .item .actions a.editbox {visibility:visible;opacity:1;font-weight:bold;}
...
.portfolios .item .vignette {margin-' .
table_valeur($Pile["vars"], (string)'left', null) .
':-160px; width: 150px; text-align: center; float:' .
table_valeur($Pile["vars"], (string)'left', null) .
';}
...
.portfolios .item .infos {display:block;}
...
.portfolios .item .actions a.editbox { visibility: visible; opacity: 1; float: right; margin-top: 1em; font-weight: bold; }
