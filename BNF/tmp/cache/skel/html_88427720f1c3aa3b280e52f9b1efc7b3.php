...
// Temps de compilation total: 2.468 ms
//

function html_88427720f1c3aa3b280e52f9b1efc7b3($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
ul.forums li .cartouche .numero {position: absolute;' .
table_valeur($Pile["vars"], (string)'right', null) .
': 5px;font-size: 1.5em;color:#bbb;font-weight: bold;font-style: italic;}
...
' .
vide($Pile['vars'][$_zzz=(string)'border'] = table_valeur($Pile["vars"], (string)'foncee', null)) .
...
' .
vide($Pile['vars'][$_zzz=(string)'border'] = (	'#' .
...
' .
vide($Pile['vars'][$_zzz=(string)'fond'] = (	'#' .
...
');
	...
	return analyse_resultat_skel('html_88427720f1c3aa3b280e52f9b1efc7b3', $Cache, $page, '../plugins-dist/forum/prive/style_prive_plugin_forum.html');
}
?>