...
// Temps de compilation total: 1.659 ms
//
...
charge_scripts('prive/themes/spip/box.css',false) .
'
...
.note .inner{border-color:#eee; border-width:4px; background-color:' .
...
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'claire', null),true)) .
'; border: 0; box-shadow: 0 0 15px #ccc;}
...
.simple.sous-rub .inner .hd .logo {float:' .
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'right', null),true)) .
';margin: 1px 5px 0;margin-' .
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'right', null),true)) .
': -9px;z-index:2;position:relative;}
...
.bloc_depliable .pagination{ white-space:normal; }');
	...
	return analyse_resultat_skel('html_5300eff4f12a488f86b9ec3d61761fca', $Cache, $page, '../prive/themes/spip/box_skins.css.html');
}
?>