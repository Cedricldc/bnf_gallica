...
// Temps de compilation total: 7.749 ms
//
...
'/* Valeurs par defaut :
' .
vide($Pile['vars'][$_zzz=(string)'font-size'] = interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'font-size', null), '1em'),true))) .
(($t1 = strval(table_valeur($Pile["vars"], (string)'font-size', null)))!=='' ?
		(' font-size: ' . $t1 . ';') :
		'') .
'
' .
vide($Pile['vars'][$_zzz=(string)'line-height'] = interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'line-height', null), '1.2em'),true))) .
(($t1 = strval(table_valeur($Pile["vars"], (string)'line-height', null)))!=='' ?
		(' line-height: ' . $t1 . ';') :
		'') .
'
' .
vide($Pile['vars'][$_zzz=(string)'margin-bottom'] = interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'margin-bottom', null), '1.2em'),true))) .
...
'
' .
vide($Pile['vars'][$_zzz=(string)'font-family'] = interdire_scripts(sinon(table_valeur(@$Pile[0], (string)'font-family', null), 'Verdana, Geneva, sans-serif'))) .
...
' .
vide($Pile['vars'][$_zzz=(string)'coeff'] = div(div(plus(table_valeur($Pile["vars"], (string)'line-height', null),'2'),'2'),table_valeur($Pile["vars"], (string)'line-height', null))) .
vide($Pile['vars'][$_zzz=(string)'coeffinv'] = div('1',table_valeur($Pile["vars"], (string)'coeff', null))) .
'h1,.h1 {' .
...
' .
vide($Pile['vars'][$_zzz=(string)'coeff'] = div(div(plus(table_valeur($Pile["vars"], (string)'line-height', null),'1'),'2'),table_valeur($Pile["vars"], (string)'line-height', null))) .
vide($Pile['vars'][$_zzz=(string)'coeffinv'] = div('1',table_valeur($Pile["vars"], (string)'coeff', null))) .
'h3,.h3 {' .
(($t1 = strval(mult(table_valeur($Pile["vars"], (string)'line-height', null),table_valeur($Pile["vars"], (string)'coeff', null))))!=='' ?
		(' font-size: ' . $t1 . 'em') :
...
'font-weight: bold; }
' .
vide($Pile['vars'][$_zzz=(string)'coeff'] = div(div(plus(table_valeur($Pile["vars"], (string)'line-height', null),'3'),'4'),table_valeur($Pile["vars"], (string)'line-height', null))) .
vide($Pile['vars'][$_zzz=(string)'coeffinv'] = div('1',table_valeur($Pile["vars"], (string)'coeff', null))) .
...
');
	...
	return analyse_resultat_skel('html_9106ad5f10151beff44bf945fd7c969b', $Cache, $page, '../prive/themes/spip/typo.css.html');
}
?>