...
function BOUCLE_enlignehtml_42ff770a558278a0a2a8b18a0d196c13(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$command['where'] = 
			array(
			array('NOT', 
			array('=', 'auteurs.id_auteur', sql_quote(interdire_scripts(invalideur_session($Cache, table_valeur($GLOBALS["visiteur_session"], (string)'id_auteur', null))), '', 'char'))), sql_in('auteurs.statut',sql_quote($in)), 
			array('NOT', 
			array('=', 'auteurs.imessage', "'non'")), 
			array('>', 'auteurs.en_ligne', sql_quote(date('Y-m-d H:i:s',strtotime('-15 minutes')), '', 'char')));
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/objets/liste/auteurs_enligne.html','html_42ff770a558278a0a2a8b18a0d196c13','_enligne',1,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
// Temps de compilation total: 1.395 ms
//

function html_42ff770a558278a0a2a8b18a0d196c13($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {

	if (isset($Pile[0]["doublons"]) AND is_array($Pile[0]["doublons"]))
		$doublons = nettoyer_env_doublons($Pile[0]["doublons"]);

	$connect = '';
	$page = (($t1 = BOUCLE_enlignehtml_42ff770a558278a0a2a8b18a0d196c13($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
<div class=\'en_lignes\'>
<b>' .
...
')) :
	...
	return analyse_resultat_skel('html_42ff770a558278a0a2a8b18a0d196c13', $Cache, $page, '../prive/objets/liste/auteurs_enligne.html');
}
?>