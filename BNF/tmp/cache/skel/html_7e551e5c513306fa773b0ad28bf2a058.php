...
function BOUCLE_liste_brehtml_7e551e5c513306fa773b0ad28bf2a058(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
  ...
  'lien' => true,
	...
	$senstri = '';
	$tri = (($t=(isset($Pile[0]['tri'.'_liste_bre']))?$Pile[0]['tri'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('tri'.'_liste_bre'))?session_get('tri'.'_liste_bre'):interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'par', null), 'date'),true))))?tri_protege_champ($t):'');
	if ($tri){
		$senstri = ((intval($t=(isset($Pile[0]['sens'.'_liste_bre']))?$Pile[0]['sens'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('sens'.'_liste_bre'))?session_get('sens'.'_liste_bre'):(is_array($s=table_valeur($Pile["vars"], (string)'defaut_tri', null))?(isset($s[$st=(($t=(isset($Pile[0]['tri'.'_liste_bre']))?$Pile[0]['tri'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('tri'.'_liste_bre'))?session_get('tri'.'_liste_bre'):interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'par', null), 'date'),true))))?tri_protege_champ($t):'')])?$s[$st]:reset($s)):$s)))==-1 OR $t=='inverse')?-1:1);
	...
	$command['where'] = 
			...
			array('=', 'breves.id_breve', sql_quote(@$Pile[0]['id_breve'], '', '')))), (!(is_array(@$Pile[0]['id_secteur'])?count(@$Pile[0]['id_secteur']):strlen(@$Pile[0]['id_secteur'])) ? '' : ((is_array(@$Pile[0]['id_secteur'])) ? sql_in('breves.id_rubrique',sql_quote($in1)) : 
			array('=', 'breves.id_rubrique', sql_quote(@$Pile[0]['id_secteur'], '', '')))), (!(is_array(@$Pile[0]['id_mot'])?count(@$Pile[0]['id_mot']):strlen(@$Pile[0]['id_mot'])) ? '' : ((is_array(@$Pile[0]['id_mot'])) ? sql_in('L1.id_mot',sql_quote($in2)) : 
			array('=', 'L1.id_mot', sql_quote(@$Pile[0]['id_mot'], '', '')))), (!(is_array(@$Pile[0]['id_rubrique'])?count(@$Pile[0]['id_rubrique']):strlen(@$Pile[0]['id_rubrique'])) ? '' : ((is_array(@$Pile[0]['id_rubrique'])) ? sql_in('breves.id_rubrique',sql_quote($in3)) : 
			array('=', 'breves.id_rubrique', sql_quote(@$Pile[0]['id_rubrique'], '', '')))), ((@$Pile[0]["where"]) ? (@$Pile[0]["where"]) : ''), $rech_where?$rech_where:'', (!(is_array(@$Pile[0]['statut'])?count(@$Pile[0]['statut']):strlen(@$Pile[0]['statut'])) ? '' : ((is_array(@$Pile[0]['statut'])) ? sql_in('breves.statut',sql_quote($in4)) : 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../plugins-dist/breves/prive/objets/liste/breves.html','html_7e551e5c513306fa773b0ad28bf2a058','_liste_bre',8,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'</td>
	...
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_liste_bre @ ../plugins-dist/breves/prive/objets/liste/breves.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}
...
function html_7e551e5c513306fa773b0ad28bf2a058($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
	...
	$connect = '';
	$page = (
(($t1 = strval(vide($Pile['vars'][$_zzz=(string)'defaut_tri'] = array('date' => interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'date_sens', null), '-1'),true)), 'date_heure' => interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'date_sens', null), '-1'),true)), 'titre' => '1', 'id_breve' => '1', 'points' => '-1
'))))!=='' ?
		($t1 . '
') :
		'') .
(($t1 = BOUCLE_liste_brehtml_7e551e5c513306fa773b0ad28bf2a058($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
' .
...
' .
	...
	<thead>
		...
		lien_ou_expose(parametre_url(parametre_url(self(),(($s=in_array('statut',array('>','<')))?'sens':'tri').'_liste_bre',$s?(strpos('< >','statut')-1):'statut'),'var_memotri',strncmp('_liste_bre','session',7)==0?(($s=in_array('statut',array('>','<')))?'sens':'tri').'_liste_bre':''),(	'<span title="' .
			attribut_html(_T('public|spip|ecrire:lien_trier_statut')) .
			'">#</span>'),$s?(((intval($t=(isset($Pile[0]['sens'.'_liste_bre']))?$Pile[0]['sens'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('sens'.'_liste_bre'))?session_get('sens'.'_liste_bre'):(is_array($s=table_valeur($Pile["vars"], (string)'defaut_tri', null))?(isset($s[$st=(($t=(isset($Pile[0]['tri'.'_liste_bre']))?$Pile[0]['tri'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('tri'.'_liste_bre'))?session_get('tri'.'_liste_bre'):interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'par', null), 'date'),true))))?tri_protege_champ($t):'')])?$s[$st]:reset($s)):$s)))==-1 OR $t=='inverse')?-1:1)==(strpos('< >','statut')-1)):((($t=(isset($Pile[0]['tri'.'_liste_bre']))?$Pile[0]['tri'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('tri'.'_liste_bre'))?session_get('tri'.'_liste_bre'):interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'par', null), 'date'),true))))?tri_protege_champ($t):'')=='statut'),'ajax') .
		'</th>
			<th class=\'titre\' scope=\'col\'>' .
		lien_ou_expose(parametre_url(parametre_url(self(),(($s=in_array('titre',array('>','<')))?'sens':'tri').'_liste_bre',$s?(strpos('< >','titre')-1):'titre'),'var_memotri',strncmp('_liste_bre','session',7)==0?(($s=in_array('titre',array('>','<')))?'sens':'tri').'_liste_bre':''),_T('public|spip|ecrire:info_titre'),$s?(((intval($t=(isset($Pile[0]['sens'.'_liste_bre']))?$Pile[0]['sens'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('sens'.'_liste_bre'))?session_get('sens'.'_liste_bre'):(is_array($s=table_valeur($Pile["vars"], (string)'defaut_tri', null))?(isset($s[$st=(($t=(isset($Pile[0]['tri'.'_liste_bre']))?$Pile[0]['tri'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('tri'.'_liste_bre'))?session_get('tri'.'_liste_bre'):interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'par', null), 'date'),true))))?tri_protege_champ($t):'')])?$s[$st]:reset($s)):$s)))==-1 OR $t=='inverse')?-1:1)==(strpos('< >','titre')-1)):((($t=(isset($Pile[0]['tri'.'_liste_bre']))?$Pile[0]['tri'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('tri'.'_liste_bre'))?session_get('tri'.'_liste_bre'):interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'par', null), 'date'),true))))?tri_protege_champ($t):'')=='titre'),'ajax') .
		'</th>
			<th class=\'date\' scope=\'col\'>' .
		lien_ou_expose(parametre_url(parametre_url(self(),(($s=in_array('date',array('>','<')))?'sens':'tri').'_liste_bre',$s?(strpos('< >','date')-1):'date'),'var_memotri',strncmp('_liste_bre','session',7)==0?(($s=in_array('date',array('>','<')))?'sens':'tri').'_liste_bre':''),_T('public|spip|ecrire:date'),$s?(((intval($t=(isset($Pile[0]['sens'.'_liste_bre']))?$Pile[0]['sens'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('sens'.'_liste_bre'))?session_get('sens'.'_liste_bre'):(is_array($s=table_valeur($Pile["vars"], (string)'defaut_tri', null))?(isset($s[$st=(($t=(isset($Pile[0]['tri'.'_liste_bre']))?$Pile[0]['tri'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('tri'.'_liste_bre'))?session_get('tri'.'_liste_bre'):interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'par', null), 'date'),true))))?tri_protege_champ($t):'')])?$s[$st]:reset($s)):$s)))==-1 OR $t=='inverse')?-1:1)==(strpos('< >','date')-1)):((($t=(isset($Pile[0]['tri'.'_liste_bre']))?$Pile[0]['tri'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('tri'.'_liste_bre'))?session_get('tri'.'_liste_bre'):interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'par', null), 'date'),true))))?tri_protege_champ($t):'')=='date'),'ajax') .
		'</th>
			<th class=\'id\' scope=\'col\'>' .
		lien_ou_expose(parametre_url(parametre_url(self(),(($s=in_array('id_breve',array('>','<')))?'sens':'tri').'_liste_bre',$s?(strpos('< >','id_breve')-1):'id_breve'),'var_memotri',strncmp('_liste_bre','session',7)==0?(($s=in_array('id_breve',array('>','<')))?'sens':'tri').'_liste_bre':''),_T('public|spip|ecrire:info_numero_abbreviation'),$s?(((intval($t=(isset($Pile[0]['sens'.'_liste_bre']))?$Pile[0]['sens'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('sens'.'_liste_bre'))?session_get('sens'.'_liste_bre'):(is_array($s=table_valeur($Pile["vars"], (string)'defaut_tri', null))?(isset($s[$st=(($t=(isset($Pile[0]['tri'.'_liste_bre']))?$Pile[0]['tri'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('tri'.'_liste_bre'))?session_get('tri'.'_liste_bre'):interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'par', null), 'date'),true))))?tri_protege_champ($t):'')])?$s[$st]:reset($s)):$s)))==-1 OR $t=='inverse')?-1:1)==(strpos('< >','id_breve')-1)):((($t=(isset($Pile[0]['tri'.'_liste_bre']))?$Pile[0]['tri'.'_liste_bre']:((strncmp('_liste_bre','session',7)==0 AND session_get('tri'.'_liste_bre'))?session_get('tri'.'_liste_bre'):interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'par', null), 'date'),true))))?tri_protege_champ($t):'')=='id_breve'),'ajax') .
		'</th>
		</tr>
	</thead>
	<tbody>
...
');
	...
	return analyse_resultat_skel('html_7e551e5c513306fa773b0ad28bf2a058', $Cache, $page, '../plugins-dist/breves/prive/objets/liste/breves.html');
}
?>