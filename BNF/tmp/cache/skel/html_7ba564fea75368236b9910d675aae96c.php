...
function BOUCLE_objetshtml_7ba564fea75368236b9910d675aae96c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/themes/spip/lists.css.html','html_7ba564fea75368236b9910d675aae96c','_objets',79,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
function BOUCLE_objets2html_7ba564fea75368236b9910d675aae96c(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/themes/spip/lists.css.html','html_7ba564fea75368236b9910d675aae96c','_objets2',155,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
.liste-objets.auteurs td.logo,.liste-objets.visiteurs td.logo {width:40px;}
.liste-objets.auteurs tr td.logo a,
.liste-objets.visiteurs tr td.logo a {width: 40px; height: 40px; display: block; background-position: center center; background-size: cover; border-radius: 50%; margin: 3px 0;}
