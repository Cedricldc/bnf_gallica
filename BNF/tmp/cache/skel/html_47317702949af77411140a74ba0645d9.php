...
// Temps de compilation total: 1.927 ms
//
...
.graphInfo td.legendLabel { padding-' .
table_valeur($Pile["vars"], (string)'left', null) .
':0; padding-' .
table_valeur($Pile["vars"], (string)'right', null) .
':1em; vertical-align: top;}
...
'");}
.stats_referers .liste-items.referers li.referer span.visites {float:left;text-align:' .
table_valeur($Pile["vars"], (string)'right', null) .
';width:140px;margin-left:-150px;}
.stats_referers .liste-items.referers li.referer .miniature {float:' .
table_valeur($Pile["vars"], (string)'right', null) .
';}
...
');
	...
	return analyse_resultat_skel('html_47317702949af77411140a74ba0645d9', $Cache, $page, '../plugins-dist/statistiques/prive/style_prive_plugin_stats.html');
}
?>