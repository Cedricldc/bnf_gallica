...
function BOUCLE_artsrhtml_c89811f70f247a8cfd227817a37ab8fe(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$command['where'] = 
			array(
			array('=', 'articles.statut', sql_quote(interdire_scripts($Pile[$SP-2]['valeur']), '', 'char')), sql_in('articles.id_rubrique', calcul_branche_in(sql_quote($Pile[$SP]['id_rubrique'], '', 'int NOT NULL'))));
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_c89811f70f247a8cfd227817a37ab8fe','_artsr',11,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
function BOUCLE_restreintshtml_c89811f70f247a8cfd227817a37ab8fe(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('rubriques.statut','!','publie',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_c89811f70f247a8cfd227817a37ab8fe','_restreints',10,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'
				' .
BOUCLE_artsrhtml_c89811f70f247a8cfd227817a37ab8fe($Cache, $Pile, $doublons, $Numrows, $SP)
...
function BOUCLE_artshtml_c89811f70f247a8cfd227817a37ab8fe(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$command['where'] = 
			array(
			array('=', 'articles.statut', sql_quote(interdire_scripts(safehtml($Pile[$SP]['valeur'])), '', 'char')));
	if (defined("_BOUCLE_PROFILER")) $timer = time()+microtime();
	$t0 = "";
	// REQUETE
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_c89811f70f247a8cfd227817a37ab8fe','_arts',6,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
(($t1 = BOUCLE_restreintshtml_c89811f70f247a8cfd227817a37ab8fe($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		($t1 . (	'
				' .
...
function BOUCLE_cpthtml_c89811f70f247a8cfd227817a37ab8fe(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_c89811f70f247a8cfd227817a37ab8fe','_cpt',3,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
	while ($Pile[$SP]=$iter->fetch()) {
		...
		$t0 .= BOUCLE_artshtml_c89811f70f247a8cfd227817a37ab8fe($Cache, $Pile, $doublons, $Numrows, $SP);
	}
	$iter->free();
	}
	if (defined("_BOUCLE_PROFILER")
...
function BOUCLE_autshtml_c89811f70f247a8cfd227817a37ab8fe(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$command['where'] = 
			array(
			array('=', 'auteurs.statut', sql_quote(interdire_scripts($Pile[$SP]['valeur']), '', 'char')));
	if (defined("_BOUCLE_PROFILER")) $timer = time()+microtime();
	$t0 = "";
	// REQUETE
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_c89811f70f247a8cfd227817a37ab8fe','_auts',25,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
function BOUCLE_cptahtml_c89811f70f247a8cfd227817a37ab8fe(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/accueil-information.html','html_c89811f70f247a8cfd227817a37ab8fe','_cpta',22,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
	while ($Pile[$SP]=$iter->fetch()) {
		...
		$t0 .= (
BOUCLE_autshtml_c89811f70f247a8cfd227817a37ab8fe($Cache, $Pile, $doublons, $Numrows, $SP)
. (	'
			' .
	(($Numrows['_auts']['total'])  ?
			(' ' . (	'
...
'
' .
(($t1 = BOUCLE_cpthtml_c89811f70f247a8cfd227817a37ab8fe($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
	<h4>' .
...
<div class=\'accueil_informations auteurs liste\'>
	' .
(($t1 = BOUCLE_cptahtml_c89811f70f247a8cfd227817a37ab8fe($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
		<h4>' .
...
');
	...
	return analyse_resultat_skel('html_c89811f70f247a8cfd227817a37ab8fe', $Cache, $page, '../prive/squelettes/inclure/accueil-information.html');
}
?>