 ...
 * Compile :   Fri, 19 May 2017 15:13:43 GMT
 * Boucles :   
 */ 
//
// Fonction principale du squelette ../prive/squelettes/inclure/head.html
// Temps de compilation total: 3.993 ms
//
...
interdire_scripts(concat(((($a = eval('return '.'_DIR_RACINE'.';')) OR (is_string($a) AND strlen($a))) ? $a : './'),interdire_scripts(eval('return '.'_SPIP_SCRIPT'.';')))) .
...
')) :
		'') .
(($t1 = strval(url_absolue(find_in_path('spip.ico'))))!=='' ?
