...
// Temps de compilation total: 5.839 ms
//
...
/* ul li -----*/
.formulaire_spip fieldset {padding-left:10px;padding-right:10px;margin-bottom:' .
(($t1 = strval(interdire_scripts(div(entites_html(table_valeur(@$Pile[0], (string)'margin-bottom', null),true),'4'))))!=='' ?
		($t1 . 'em') :
		'') .
'}
.formulaire_spip .editer-groupe {padding: ' .
(($t1 = strval(interdire_scripts(div(entites_html(table_valeur(@$Pile[0], (string)'margin-bottom', null),true),'4'))))!=='' ?
		($t1 . 'em') :
		'') .
' 0;}
...
.formulaire_spip .editer {padding: ' .
(($t1 = strval(interdire_scripts(div(entites_html(table_valeur(@$Pile[0], (string)'margin-bottom', null),true),'2'))))!=='' ?
		($t1 . 'em') :
		'') .
...
.formulaire_spip .editer.gauche {padding-' .
...
.formulaire_spip .choix :not(.editer)>label {font-weight:normal;text-transform: none;float:none;display:inline;margin-' .
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'left', null),true)) .
': 5px;color: #666666;}
...
.error,.success,.notice,.information {border:2px solid;color:#333;font-weight: normal;padding:' .
(($t1 = strval(interdire_scripts(div(entites_html(table_valeur(@$Pile[0], (string)'margin-bottom', null),true),'2'))))!=='' ?
		($t1 . 'em') :
		'') .
...
.lat .formulaire_spip .editer {padding: ' .
(($t1 = strval(interdire_scripts(div(entites_html(table_valeur(@$Pile[0], (string)'margin-bottom', null),true),'4'))))!=='' ?
		($t1 . 'em') :
		'') .
' 5px;}

.lat .formulaire_spip .editer label {text-transform: none;color: #444444;display:block;font-weight: normal;float:none;padding: 0;width:auto;margin-' .
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'left', null),true)) .
':0;}
...
.formulaire_editer_auteur .editer.editer_statut .instituer_auteur {margin-' .
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'left', null),true)) .
':-130px;margin-top:10px;}
.formulaire_editer_auteur .editer.editer_statut .rubriques_restreintes > p {margin-' .
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'left', null),true)) .
':0;margin-bottom:0;margin-top:10px;}
.formulaire_editer_auteur .editer.editer_statut .rubriques_restreintes label { float: none; width: auto; margin-' .
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'left', null),true)) .
': 0; }
...
.formulaire_editer_logo .spip_logo img, .portfolios .vignette img, #documents_joints img.spip_logo {
		background: url(' .
interdire_scripts(chemin_image('fond-imgs.png')) .
');
}
.formulaire_editer_logo .taille {font-size: 0.9em;}

.formulaire_configurer_multilinguisme #langues_bloquees .choix,
.formulaire_configurer_multilinguisme #langues_proposees .choix { padding:0 5px;margin-' .
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'right', null),true)) .
':10px;float:' .
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'left', null),true)) .
';width:45%;clear:none; background: transparent; border: 0; }
...
.formulaire_dater .editer label {font-weight: bold;text-transform: uppercase;font-size:0.9em;}
...
interdire_scripts(entites_html(table_valeur(@$Pile[0], (string)'left', null),true)) .
';line-height:1px;position:absolute;top:2px;left:2px;z-index:2}
...
');
	...
	return analyse_resultat_skel('html_e7a2e343aa900fa80ee36f1dd7507320', $Cache, $page, '../prive/themes/spip/forms.css.html');
}
?>