...
define('_DIR_PLUGIN_VERIFIER',_DIR_PLUGINS.'auto/verifier/v1.0.11/');
define('_DIR_PLUGIN_SAISIES',_DIR_PLUGINS.'auto/saisies/v2.11.2/');
define('_DIR_PLUGIN_CEXTRAS',_DIR_PLUGINS.'auto/cextras/v3.11.0/');
define('_DIR_PLUGIN_IEXTRAS',_DIR_PLUGINS.'auto/iextras/v3.5.2/');
...
if (_DIR_RESTREINT) _chemin(implode(':',array(_DIR_PLUGIN_TW,_DIR_PLUGIN_MEDIAS,_DIR_PLUGIN_MEDIAS.'squelettes/',_DIR_PLUGIN_COMPRESSEUR,_DIR_PLUGIN_BREVES,_DIR_PLUGIN_IEXTRAS,_DIR_PLUGIN_CEXTRAS,_DIR_PLUGIN_SAISIES,_DIR_PLUGIN_VERIFIER,_DIR_PLUGIN_YAML,_DIR_PLUGIN_SKELEDITOR,_DIR_PLUGIN_VERTEBRES,_DIR_PLUGIN_URLS,_DIR_PLUGIN_SVP,_DIR_PLUGIN_STATS,_DIR_PLUGIN_SQUELETTES_PAR_RUBRIQUE,_DIR_PLUGIN_SITES,_DIR_PLUGIN_SAFEHTML,_DIR_PLUGIN_REVISIONS,_DIR_PLUGIN_PORTE_PLUME,_DIR_PLUGIN_PLAN,_DIR_PLUGIN_PETITIONS,_DIR_PLUGIN_ORGANISEUR,_DIR_PLUGIN_MOTS,_DIR_PLUGIN_MEDIABOX,_DIR_PLUGIN_JQUERYUI,_DIR_PLUGIN_JQUERYUI.'prive/',_DIR_PLUGIN_FORUM,_DIR_PLUGIN_IMAGES,_DIR_PLUGIN_DUMP,_DIR_PLUGIN_COMPAGNON)));
else _chemin(implode(':',array(_DIR_PLUGIN_TW,_DIR_PLUGIN_MEDIAS,_DIR_PLUGIN_MEDIAS.'squelettes/',_DIR_PLUGIN_COMPRESSEUR,_DIR_PLUGIN_BREVES,_DIR_PLUGIN_IEXTRAS,_DIR_PLUGIN_CEXTRAS,_DIR_PLUGIN_SAISIES,_DIR_PLUGIN_VERIFIER,_DIR_PLUGIN_YAML,_DIR_PLUGIN_SKELEDITOR,_DIR_PLUGIN_VERTEBRES,_DIR_PLUGIN_URLS,_DIR_PLUGIN_SVP,_DIR_PLUGIN_STATS,_DIR_PLUGIN_SQUELETTES_PAR_RUBRIQUE,_DIR_PLUGIN_SITES,_DIR_PLUGIN_SAFEHTML,_DIR_PLUGIN_REVISIONS,_DIR_PLUGIN_PORTE_PLUME,_DIR_PLUGIN_PLAN,_DIR_PLUGIN_PETITIONS,_DIR_PLUGIN_ORGANISEUR,_DIR_PLUGIN_MOTS,_DIR_PLUGIN_MEDIABOX,_DIR_PLUGIN_JQUERYUI,_DIR_PLUGIN_JQUERYUI.'prive/',_DIR_PLUGIN_FORUM,_DIR_PLUGIN_IMAGES,_DIR_PLUGIN_DUMP,_DIR_PLUGIN_COMPAGNON)));
}
?>